...
class SegmentsControllerTest < ActionController::TestCase
  ...
  test "should create segment" do
    assert_difference('Segment.count') do
      post :create, segment: { description: @segment.description, name: @segment.name, plan_id: @segment.plan_id, thumbnail: @segment.thumbnail }
    end
  ...
  test "should update segment" do
    patch :update, id: @segment, segment: { description: @segment.description, name: @segment.name, plan_id: @segment.plan_id, thumbnail: @segment.thumbnail }
    assert_redirected_to segment_path(assigns(:segment))
  end
